 ...
 * if an invalid patch -> 400 Bad Request
 *
...
public class PatchUserByIdTests {
    ...
    public void whenSuccess_expected200() throws Exception {
        ...
        // then
        mvc.perform(MockMvcRequestBuilders.patch(REQUEST_PATH, MOCK_USER_ID)
    ...
    public void whenNicknameOccupied_expect409() throws Exception {
        ...
        doThrow(new NicknameOccupiedException()).when(userService).patchById(any(), any());
    ...
    public void whenUserInvalid_expect400() throws Exception {
        User candidate = User.builder().familyName("a!@#$#$sd").build();
